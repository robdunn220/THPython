...
def build_cells(width, height):
    """Create and return a grid of two-tuples
...
def get_locations(cells):
    """Randomly pick starting locations for the players, NPC's, and objects
    >>> cells = build_cells(2,2)
...
def get_moves(player):
    """Return list of moves based on players current position
    >>> GAME_DIMENSIONS = build_cells(2,2)
    >>> get_moves((0, 2))
    ['RIGHT', 'UP', 'DOWN']
    """
    x, y = player
